...
**Buy-Side Trading & Financial Analytics** | CFA Level 1 Candidate • CIMA Candidate • FMVA Candidate  
...
## 📜 Verified Institutional Credentials & Research Assessments

* **Dominion Financial Review Ltd** — *Dominion Programme: Finance Research Assessment* (July 2025) `[Verified]`
* **Goldman Sachs** — *Financial & Quantitative Analysis / Operations* `[Verified]`
* **J.P. Morgan** — *Investment Banking Simulation* `[Verified]`
* **Bank of America** — *Investment Banking Simulation* `[Verified]`
* **Citi** — *Markets Sales & Trading / Investment Banking* `[Verified]`
* **Fidelity International** — *Investment Management Simulation* `[Verified]`
* **Standard Chartered** — *Credit Analysis Simulation* `[Verified]`
